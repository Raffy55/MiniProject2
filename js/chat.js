...
// const umessage = document.querySelector("user-message");
...
chatHeader.addEventListener("click", () => {
    ...
    chatBody.classList.toggle("collapse");
    chatHeader.classList.toggle("collapse");
    // umessage.classList.toggle("collapse");
})
